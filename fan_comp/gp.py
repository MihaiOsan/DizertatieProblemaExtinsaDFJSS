...
# CONFIG
# ---------------------------------------------------------------------------
TRAIN_DIR = Path("/Users/mihaiosan/PycharmProjects/DizertatieProblemaExtinsaDFJSS/dynamic_data/fan21/training_sets")
TEST_DIR = Path("/Users/mihaiosan/PycharmProjects/DizertatieProblemaExtinsaDFJSS/dynamic_data/fan21/test_sets")
POP_SIZE = 40
N_GENERATIONS = 25
N_WORKERS = 5
MAX_HOF = 5

BASE_OUTPUT_DIR = Path("/Users/mihaiosan/PycharmProjects/DizertatieProblemaExtinsaDFJSS/fan_comp/rezultate/genetic")
