...
if __name__ == "__main__":
    os.makedirs("dynamic_data/fan21/training_sets", exist_ok=True)
    os.makedirs("dynamic_data/fan21/test_sets", exist_ok=True)

    train_instances_no = 10
    test_instances_no = 10
        ...
        for util in train_util_list:
            for ec in train_etpc_list:
                for num_machines in num_machines_range:
                    ...
                    fname = f"dynamic_data/fan21/training_sets/train_fan21_{train_id}_util{util}_ec{ec}_nm{num_machines}_v{vers}.json"
        ...
        for util in test_util_list:
            for ec in test_etpc_list:
                for num_machines in num_machines_range:
                    ...
                    fname_test = f"dynamic_data/fan21/test_sets/test_fan21_{test_id}_util{util}_ec{ec}_nm{num_machines}_v{vers}.json"
